...
main = do
    let (n1, n2, q1, q2, q3, q4) = zahlensystem 12
        ...
        -- Liste der 8 Bruchteile (Zähler und Nenner der Quotienten)
        ...
        -- Die 8 Werte als Strings für die Beschriftung (mit / anstelle von %)
        values = [
    ...
    -- ABSCHNITT 2: Winkelberechnungen (12 Ausgaben)
